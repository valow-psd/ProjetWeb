<template>
  <v-container>
    <v-row>
      <v-btn variant="outlined" icon color="secondary" @click=" menuouvert = !menuouvert" ><v-icon>mdi-menu</v-icon></v-btn>
      ...
      <v-list-item>
        <v-list-item-content>
          ...
          <v-btn v-if="menuouvert" to="Login" @click="$router.push('/Login')"> Se Connecter </v-btn>
        </v-list-item-content>
      </v-list-item>
    </v-navigation-drawer>
  </v-row>
